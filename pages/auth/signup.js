    ...
    <div className="container">
     ...
     <div className="d-flex vh-100 justify-content-center" >
        <div className="box col-xl-5 col-lg-5 col-md-7 col-sm-8 col-10 align-self-center  " >
             ...
             <div className="info">
                <h3>Welcome To Signup' Form </h3>
             </div>
             <div className="form-group py-2">
              <input type="text" placeholder='Full Name' className='login-input px-5' />
             </div>
             <div className="form-group py-2">
              <input type="text" placeholder='Email' className='login-input px-5' />
             </div>
             <div className="form-group py-2">
              <input type="password" placeholder='Password' className='login-input px-5' />
             </div>
             <div className="form-group py-2">
              <input type="password" placeholder='Confirm password' className='login-input px-5' />
             </div>
             <div className=" py-2">
                <button className='btn-login '>Sign up</button>
             </div>
             <span className='font-18 fw-bold'>OR</span>
             <div className='mb-3'>Sign up With</div>
             <div className='btns'>
